...
\caption{List of all commands} \\
    ...
    Cref  & Subsequence cross-reference (to a \textbackslash{}label) & Cross-referencing \\
    ...
    phantomsection & If the target of a cross-reference is not a figure, table, or section (\emph{i.e.} it occurs in the middle of a paragraph), use \textbackslash{}phantomsection\textbackslash{}label{<key>} to anchor the cross-reference & Cross-referencing \\[30pt] 
    ...
    GrattanReportNumber & Prints the report number on page 2 & Single-use \\
    GrattanWorkingPaperNumber & Prints the working paper number on page 2 & Single-use \\
    listoffigures & Print list of figures (currently handled by \textbackslash{}contentspage) & Single-use \\
