...
8. Open up a command prompt (Windows) or terminal (iOS / Linux) and type `tex null\bye` then hit Enter/Return. The output should be something like
    ...
    If the above is not returned in the console, your installation is faulty. 
