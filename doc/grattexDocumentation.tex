...
and must be the first author in \lstinline!\author!.
...
\end{figure}
\end{lstlisting}
\rationale{Eases cross-referencing later. Req.\ to check all figs/tbls have been referenced.}
...
\rationale{Respects English spacing}
\end{enumerate}
...
\subsection{All labels and figures referenced}
\begin{enumerate}
...
@Misc{GST-Act-1999,
  ...
  year  = {Cth},
    ...
    \end{lstlisting}
    This kludge may be avoided in future versions.
    \item You use the literal \lstinline!{n.d.}! for which the date of publication is unknown.\footnote{This is expected to change in Biber 2.8.}
  ...
  \end{enumerate}
    ...
    \rationale{Ensures true warnings are not masked. Ensures citation portability.}
\end{enumerate}
