...
\end{lstlisting}
further, if those stop words form part of the abbreviation,\marginpar{\footnotesize From v0.8.3} that combination will also be considered and added to the dictionary:
\begin{lstlisting}
% Still succeeds:
