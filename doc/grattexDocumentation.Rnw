...
\end{document}
  ...
  \begin{description}
    ...
    \begin{enumerate}
      ...
      \item \relax\lstinline!\EmbargoText! The embargo field. By default \lstinline!Embargoed until 9 pm \EmbargoDate{}!.
      \item \relax\lstinline!\EmbargoTitleText! The text printed on the title page. By default, \lstinline!\EmbargoText{}!.
    \end{enumerate}
  \end{description}
