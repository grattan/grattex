...
% 		-	Add the MONTH and YEAR to \subtitle{}, eg \subtitle{July 2020}
...
\GrattanReportNumber{0000-00} % Request a report number from admin, eg 2020-08
\MONTH{July}
...
\acknowledgements{%
This report was written by John Daley, Julie Sonnemann, and Kate Griffiths. % Note: no job titles required here. An Oxford comma is required.
James Ha provided extensive research assistance and made substantial contributions to the report. 
...
For further information on Grattan's programs, or to join our mailing list, please go to: \textcolor{blue}{\url{http://www.grattan.edu.au/}}. You can make a donation to support future Grattan reports here: \textcolor{blue}{\url{www.grattan.edu.au/donate}}.

{\footnotesize
This report may be cited as:
Daley, J., Sonnemann, J., and Griffiths, K\@. (2020). \emph{\mytitle}. Grattan Institute.
...
The box on the right (\Cref{box:test-two-line-caption}) should have a top-aligned caption (Issue \#80):
