...
\GrattanReportNumber{0000-00} % Request a report number from admin, eg 2019-08
\MONTH{July}
...
\acknowledgements{%
This report was written by Pete Goss, Julie Sonnemann, and Kate Griffiths. % Note: no job titles required here. An Oxford comma is required.
Carmela Chivers provided extensive research assistance and made substantial contributions to the report. 
James Ha also provided research assistance.
...
Daley, J., Goss, P., Sonnemann, J., Griffiths, K., and Chivers, C\@. (2019). \emph{\mytitle}. Grattan Institute.
