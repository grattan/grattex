...
% 		-	Remove \acknowledgementspage command
...
% Add a draft watermark for extra assurance when sending externally
% \usepackage{draftwatermark} #uncomment these lines to toggle the watermark on/off
%\SetWatermarkText{DRAFT} #uncomment these lines to toggle the watermark on/off
%\SetWatermarkScale{0.5} #uncomment these lines to toggle the watermark on/off
...
For further information on Grattan's programs, or to join our mailing list, please go to: \textcolor{blue}{\url{www.grattan.edu.au}}. You can donate to support future Grattan reports here: \textcolor{blue}{\url{www.grattan.edu.au/donate}}.

\newpage

\subsection*{Grattan Institute \TheReportType\ No. \TheGrattanReportNumber, \TheMONTH\ \TheYEAR}
...
The acknowledgements page appears after the appendix, followed by the bibliography. 
