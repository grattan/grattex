...
Although \LaTeX{} doesn't require it, Grattan requires every label must have a specific prefix followed by a colon, as throughout this document.
Furthermore, every chapter must be labeled, even if it is never referenced.
